...
public class DeleteFee extends JFrame{
    ...
    public DeleteFee(Client.ClientWorker clientsocket, String rUserId, String rKwota, String rData) {
        ...
        zatwierdźButton.addActionListener(e -> {
            getValueNewAdmin();
            try {
                if(clientsocket.sendDataDeleteFee(userId,kwota,data)){
                    JOptionPane.showMessageDialog(null, "Gratulacje! Usunięto karę!");
                }else{
                    JOptionPane.showMessageDialog(null, "Niestety, usunięcie kary się nie powiodło");
                }
