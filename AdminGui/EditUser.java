...
public class EditUser extends JFrame{
    ...
    public EditUser(Client.ClientWorker clientsocket, String uId, String uName, String uSurname, String uLogin, String uHaslo, String uSaldo) {
        ...
        zatwierdźButton.addActionListener(e -> {
            getValueNewAdmin();
            try {
                if(clientsocket.sendDataEditUser(aktualneId,noweImie,noweNazwisko,nowyLogin,noweHaslo,noweSaldo)){
                    JOptionPane.showMessageDialog(null, "Gratulacje! Edycja użytkownika zakończona pomyślnie!");
                }else{
                    JOptionPane.showMessageDialog(null, "Niestety edytowanie użytkownika się nie powiodło");
                }
